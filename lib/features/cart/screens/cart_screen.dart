...
import 'package:appstore/features/cart/widgets/cart_product.dart';
import 'package:appstore/features/cart/widgets/cart_subtotal.dart';
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: CustomButton(
                text: 'Tiến hành mua(${user.cart.length} hàng)',
