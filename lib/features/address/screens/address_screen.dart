...
import 'package:appstore/common/widgets/custom_textfield.dart';
import 'package:appstore/constants/global_variables.dart';
import 'package:appstore/constants/utils.dart';
import 'package:appstore/features/address/services/address_services.dart';
  ...
  void payPressed(String addressFromProvider) {
    ...
    if (isForm) {
      if (_addressFormKey.currentState!.validate()) {
        ...
        throw Exception('Vui lòng nhập tất cả các giá trị!');
      }
